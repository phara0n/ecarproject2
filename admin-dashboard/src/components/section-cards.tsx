    ...
    <div className="*:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4 grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card lg:px-6">
      <Card className="@container/card">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">eCar Garage monthly revenue</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">Customer acquisition needs attention</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">eCar Garage customer engagement</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          ...
          <div className="text-muted-foreground">eCar Garage growth projections</div>
        </CardFooter>
      </Card>
    </div>
  )
